...
1. **Ne jamais éditer à la main les JSON de données sous `site/`.** Ils sont réécrits par les workflows de refresh depuis le pipeline. Pour changer les données, modifier `pipeline/` (voir [`pipeline/README.md`](./pipeline/README.md)).
